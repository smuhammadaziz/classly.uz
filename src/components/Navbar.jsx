...
function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex md:items-center md:space-x-2">
            <Link
              to="/login"
              className="px-3 py-2 text-gray-700 hover:text-accent-blue font-medium transition duration-200"
            >
              Log in
            </Link>
            <Link
              to="/signup"
              className="ml-4 px-4 py-2 bg-accent-blue hover:bg-deep-blue text-white rounded-lg font-medium shadow-sm hover:shadow-md transition duration-200"
            >
              Get Started
            </Link>
          </div>
      ...
      <div
        className={`md:hidden transition duration-200 ease-in-out ${
          isOpen ? "block" : "hidden"
        }`}
      >
        <div className="pt-2 pb-3 space-y-1 bg-white border-t shadow-inner">
          ...
          <div className="mt-4 flex flex-col space-y-2 px-3">
            <Link
              to="/login"
              className="px-3 py-2 text-base font-medium text-gray-700 hover:text-accent-blue rounded-md hover:bg-gray-50"
            >
              Log in
            </Link>
            <Link
              to="/signup"
              className="px-3 py-2 text-base font-medium text-white bg-accent-blue hover:bg-deep-blue rounded-md shadow-sm"
            >
              Get Started
            </Link>
          </div>
